...
Shirt.create!(price:45 ,sku: 'Mini', name: 'Mini - Silk', category: casual, photo_url:'https://images.unsplash.com/photo-1515678916313-2263ebfad5cb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80')
Shirt.create!(price:300 ,sku: 'jean', name: 'Jean-Michel ', category: casual, photo_url: 'https://images.unsplash.com/photo-1548777331-e62dcdf5e0b9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=298&q=80')
Shirt.create!(price:3000 ,sku: 'dpg', name: 'DPG ', category: geek, photo_url: 'https://images.unsplash.com/photo-1548777331-e62dcdf5e0b9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=298&q=80')
puts 'Finished'
